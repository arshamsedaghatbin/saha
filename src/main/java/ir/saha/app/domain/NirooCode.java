...
public class NirooCode implements Serializable {
    ...
    public NirooCode karbars(Set<Karbar> karbars) {
        this.karbars = karbars;
        return this;
    }

    public NirooCode addKarbar(Karbar karbar) {
        this.karbars.add(karbar);
        karbar.setNirooCode(this);
        return this;
    }

    public NirooCode removeKarbar(Karbar karbar) {
        this.karbars.remove(karbar);
        karbar.setNirooCode(null);
        return this;
    }
