...
/**
 * REST controller for managing {@link ir.saha.app.domain.Karbar}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class KarbarResource {
     ...
     */
    @GetMapping("/karbars")
    public List<Karbar> getAllKarbars() {
        log.debug("REST request to get all Karbars");
        return karbarRepository.findAll();
    }
    ...
    public ResponseEntity<Karbar> getKarbar(@PathVariable Long id) {
        ...
        Optional<Karbar> karbar = karbarRepository.findById(id);
