            ...
            <tbody>
              {negahbaniList.map((negahbani, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{negahbani.begin ? <TextFormat type="date" value={negahbani.begin} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{negahbani.end ? <TextFormat type="date" value={negahbani.end} format={APP_DATE_FORMAT} /> : null}</td>
